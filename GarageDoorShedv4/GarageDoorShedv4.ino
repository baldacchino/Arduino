...
void loop() {
 ...
 //  Serial.print("Front buttonState: ");
 // Serial.println (GarageDoor_Front_buttonState);
 // Serial.print("Front last buttonState: ");
 // Serial.println (GarageDoor_Front_lastButtonState);
